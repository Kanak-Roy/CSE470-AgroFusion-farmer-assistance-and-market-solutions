                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="shop__sidebar__categories">
                                                ...
                                                @foreach($categories as $category)
                                                    <li><a href="{{ url('/shop?category=' . urlencode($category->category)) }}">{{ $category->category }} ({{ $category->total }})</a></li>
                                                @endforeach
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="shop__product__option__right">
                                    <form action="{{ url('/shop') }}" method="GET" id="sortForm">
                                        ...
                                        <select name="sort_by" onchange="document.getElementById('sortForm').submit()">
                                            <option value="asc" {{ request('sort_by') == 'asc' ? 'selected' : '' }}>Low to High</option>
                                            <option value="desc" {{ request('sort_by') == 'desc' ? 'selected' : '' }}>High to Low</option>
                                        </select>
                                    </form>
                                </div>
                            </div>
